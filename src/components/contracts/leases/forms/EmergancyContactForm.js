...
class EmergancyContactForm extends Component {
...
EmergancyContactForm.propTypes = {
...
EmergancyContactForm.defaultProps = {

}

// Wrap the prop in Radium to allow JS styling
const RadiumHOC = Radium(EmergancyContactForm)
