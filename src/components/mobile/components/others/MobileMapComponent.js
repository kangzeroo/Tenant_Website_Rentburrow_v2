...
class MobileMapComponent extends Component {
	...
	render() {
		return (
			<div id='MobileMapComponent' style={comStyles({}).mapContainer}>
				<div
					id='mapTarget'
...
MobileMapComponent.defaultProps = {
  listOfResults: [],
	CSS_mapWidth: '100%',
	CSS_mapHeight: '100%',
  search_radius: 1000,
...
const RadiumHOC = Radium(MobileMapComponent)
