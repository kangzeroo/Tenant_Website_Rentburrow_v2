				...
				<div style={comStyles().center} >
					<div style={comStyles().ImageGallery} >
						<SingularImageGallery
							list_of_images={suite.imgs ? [suite.cover_photo].concat(suite.imgs) : ['http://www.pbs.org/bluegrass-underground/lunchbox_plugins/s/photogallery/img/no-image-available.jpg']}
							image_size='hd'
